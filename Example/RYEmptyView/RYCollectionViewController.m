...
#import "Masonry.h"
@interface RYCollectionViewController ()<UICollectionViewDelegate, UICollectionViewDataSource>
...
- (void)viewDidLoad {
    ...
    self.collectionView.emptyView = [RYEmptyView createEmptyViewWithType:RYEmptyTypeNotContent];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UILabel *lab = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, cell.contentView.ry_width, cell.contentView.ry_height)];
